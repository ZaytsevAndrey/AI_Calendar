...
const Header: React.FC = () => {
    ...
    return (
        <header className="z-[1200] w-full shrink-0 border-b border-ide-border bg-ide-panel/95 pt-[env(safe-area-inset-top)] backdrop-blur-sm">
            <div className="flex w-full flex-col gap-2 px-4 py-2 sm:h-16 sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:px-5 sm:py-0 lg:px-8">
                ...
                <nav
                    className="-mx-1 flex gap-1 overflow-x-auto overscroll-x-contain pb-1 [-webkit-overflow-scrolling:touch] sm:mx-0 sm:pb-0"
                    aria-label="Main"
                >
