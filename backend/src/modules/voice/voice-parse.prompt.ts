...
Task rules:
- eventType "fixed" = immovable exact slot. Requires scheduledStartTime AND scheduledEndTime (ISO-8601 with offset).
...
- Dates/times: interpret relative words (today/tomorrow/ввечері) using the provided now + timezone. Output ISO-8601 with numeric offset (e.g. 2026-09-08T15:00:00+03:00).
